...
@section('title', __('public.title.title agent show'))
@section('vendor-css')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <div class="card mb-4">
                    ...
                    <div class="user-profile-header d-flex flex-column flex-sm-row text-sm-start text-center mb-4">
                        <div class="flex-shrink-0 mt-n2 mx-sm-0 mx-auto">
                            ...
                            @else
                                <img src="{{ asset('' . $agent->user->pic) }}" alt="user image"
                        ...
                        <div class="flex-grow-1 mt-3 mt-sm-5">
                            <div
                                ...
                                <div class="user-profile-info">
                                    <h4>{{ $agent->user->name . ' ' . $agent->user->family }}</h4>
                                    {{-- <ul
        ...
        <div class="row">
            <div class="col-xl-4 col-lg-5 col-md-5">
                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-unstyled mb-4 mt-3">
                            <li class="d-flex align-items-center mb-3">
                                ...
                                <span>{{ $agent->user->mobile_number }}</span>
                            </li>

                            <li class="d-flex align-items-center mb-3">
                                <i class="bx bx-envelope"></i><span class="fw-semibold mx-2">ایمیل:</span>
                                <span>{{ $agent->user->email ?? 'ندارد' }}</span>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <small class="text-muted text-uppercase">درباره  نماینده </small>
                        <ul class="list-unstyled mb-4 mt-3">

                            <li class="d-flex align-items-center mb-3">
                                <i class="bx bx-user"></i><span class="fw-semibold mx-2">نام دفتر :</span>
                                <span>{{ $agent->title }}</span>
                            </li>
                            <li class="d-flex align-items-center mb-3">
                                <i class="bx bx-user"></i><span class="fw-semibold mx-2">نام مدیر :</span>
                                <span>{{ $agent->user->name . ' ' . $agent->user->family }}</span>
                            </li>
                            <li class="d-flex align-items-center mb-3">
                                <i class="bx bx-check"></i><span class="fw-semibold mx-2">   کد نمایندگی:</span>
                                <span>{{ $agent->agent_code  }}</span>
                            </li>
                            <li class="d-flex align-items-center mb-3">
                                <i class="bx bx-check"></i><span class="fw-semibold mx-2"> سابقه کار :</span>
                                <span>{{ $agent->work_history . ' ' . 'سال' }}</span>
                            </li>
                            <li class="d-flex align-items-center mb-3">

                                <i class="bx bx-check"></i><span class="fw-semibold mx-2"> مالکیت :</span> <span>
                                    @if ($agent->is_owner == 'owner')
                                        {{ 'مالک هستم ' }}
                                    @else
                                        {{ 'مستاجر  هستم ' }}
                                    @endif
                            ...
                            <li class="d-flex align-items-center mb-3">
                                ...
                                <i class="bx bx-check"></i><span class="fw-semibold mx-2"> پارکینگ :</span> <span>
                                    @if ($agent->is_parking == 'parking')
                                        {{ 'پارکینگ دارم' }}
                                    @else
                                        {{ 'پارکینگ ندارم' }}
                                    @endif
                            ...
                            <li class="d-flex align-items-center mb-3">
                                ...
                                <i class="bx bx-check"></i><span class="fw-semibold mx-2">  وضعیت :</span> <span>
                        ...
                        <ul class="list-unstyled mb-4 mt-3">
                            <li class="d-flex align-items-center mb-3">
                                ...
                                <span>{{ $agent->user->address_office ?? 'ندارد' }}</span>
                            </li>

                            <li class="d-flex align-items-center mb-3">
                                <i class="bx bx-envelope"></i><span class="fw-semibold mx-2">آدرس : </span>
                                <span>{{ $agent->phone_office ?? 'ندارد' }}</span>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="col-xl-8 col-lg-7 col-md-7">
                ...
                <div class="card card-action mb-4">
                    <div class="card">
                        <h5 class="card-header"> وضعیت : {{ $agent->title }}</h5>
