...
@section('content')
    ...
    <div class="card mb-4">
        ...
        <form class="card-body" action="{{ route('offices.store') }}" method="POST">
            @csrf
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" id="multicol-first-name" class="form-control" placeholder="جان">
                    <span class="error">@error('name') {{$message}} @enderror</span>

                </div>
                <div class="col-md-6">
                    <label class="form-label" for="multicol-last-name">@lang('public.wizard.base.family') *</label>
                    <input type="text" name="family" value="{{ old('family') }}" id="multicol-last-name" class="form-control" placeholder="اسنو">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="father" value="{{ old('father') }}" id="multicol-last-name" class="form-control" placeholder="اسنو">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="code_meli" value="{{ old('code_meli') }}" id="multicol-last-name" class="form-control"
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group input-group-merge">
                        ...
                        <input type="text" name="email"  value="{{ old('email') }}"id="multicol-email" class="form-control text-start"
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="mobile_number" id="multicol-phone" class="form-control phone-mask text-start"
                        dir="ltr" placeholder="658 799 8941"  value="{{ old('mobile_number') }}" aria-label="658 799 8941">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="birthday" value="{{ old('birthday') }}" id="multicol-birthdate" class="form-control dob-picker"
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <input type="text" name="title" value="{{ old('title') }}" id="multicol-first-name" class="form-control" placeholder="باطری ساز">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="management" value="{{ old('management') }}" id="multicol-last-name" class="form-control" placeholder="رضا">
                    <span class="error">@error('management') {{$message}} @enderror</span>

                </div>
                <div class="col-md-6">
                    <label class="form-label" for="multicol-last-name">@lang('public.wizard.center.c_license') *</label>
                    <input type="text" name="license_number" value="{{ old('license_number') }}" id="multicol-last-name" class="form-control" placeholder="122***">
                    <span class="error">@error('license_number') {{$message}} @enderror</span>

                </div>
                <div class="col-md-6">
                    <label class="form-label" for="multicol-last-name">@lang('public.wizard.center.c_history')</label>
                    <input type="text" name="work_history"  value="{{ old('work_history') }}" id="multicol-last-name" class="form-control" placeholder="15 سال">
                </div>
                <div class="col-md-6">
                    <label class="form-label" for="multicol-last-name">@lang('public.wizard.center.c_area')</label>
                    <input type="text" name="area" value="{{ old('area') }}"  id="multicol-last-name" class="form-control" placeholder="150 متر">
                </div>
                <div class="col-md-6">
                    <label class="form-label" for="multicol-last-name">@lang('public.wizard.center.c_apprentice')</label>
                    <input type="text" name="apprentice" value="{{ old('apprentice') }}" id="multicol-last-name" class="form-control" placeholder="10 نقر">
                </div>

                <div class="col-md-6">
                    <label class="form-label" for="multicol-last-name">@lang('public.wizard.center.c_phone')</label>
                    <input type="text" name="phone_office" value="{{ old('phone_office') }}" id="multicol-last-name" class="form-control" placeholder="0313*****">
                </div>
                <div class="col-md-6">
                    <label class="form-label" for="basic-default-message">@lang('public.wizard.center.c_address')</label>
                    <textarea id="basic-default-message"  name="address_office" value="{{ old('address_office') }}" class="form-control" placeholder="متن پیام را اینجا بنویسید"></textarea>
                </div>
                <div class="col-md-3">
                ...
                <div class="col-md-3">
                    ...
                    <span class="error">@error('is_parking') {{$message}} @enderror</span>
                ...
                <div class="col-md-3">
                    ...
                    <span class="error">@error('is_owner') {{$message}} @enderror</span>
                </div>
                <div class="col-md-3">
                    ...
                    <span class="error">@error('accept') {{$message}} @enderror</span>
                </div>
