...
@section('title', __('public.title.title permissions'))
@section('vendor-css')
            ...
            <div class="card-body">
                <div class="form-row">
                    ...
                    <div class="col-sm-2">
                        <div class="form-group">
                            <label for="sending_filter" class="col-form-label">@lang('table.Dadatable.search filter name persian')</label>
                ...
                <div
                    ...
                    <div class="dt-buttons">
                        ...
                        <a href="{{ route('permissions.create') }}" class="dt-button add-new btn btn-primary"><i
                                class="bx bx-plus me-0 me-lg-2"></i><span
                                class="d-none d-lg-inline-block">@lang('table.Dadatable.add permissions')</span></a>
                    </div>
                </div>
